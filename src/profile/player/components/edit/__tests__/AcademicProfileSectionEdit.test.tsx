...
import { AcademicProfileSectionEdit } from '../components/sections/AcademicProfileSectionEdit';
import type { Academic, ValidationErrors } from '../../../types';

describe('AcademicProfileSectionEdit', () => {
    const mockFormData: Academic = {
        gpa: 3.8,
        gpaScale: '4.0 Scale',
        satScore: 1350,
        satMath: 680,
