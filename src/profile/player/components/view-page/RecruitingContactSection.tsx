            ...
            <div className="max-w-6xl mx-auto w-full">
                <div className="text-center mb-8">
                    <div className="flex items-center justify-center gap-4 mb-3">
                        <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-white">Get In Touch</h2>
                        {isOwner && !isEditing && (
                            <EditButton
                                onClick={() => onEdit?.()}
                    ...
                    <p className="text-base md:text-lg text-slate-400">Ready to recruit? Let&apos;s connect</p>
                </div>
                ...
                {isEditing ? (
                    ...
                    // Empty state - only show for owners
                    <EmptySection
                            ...
                            <div className="space-y-4">
                                ...
                                {((contact.parentGuardianName || contact.parentGuardianPhone || contact.parentGuardianEmail) || isOwner) && (
                                    <div className="mt-6 pt-6 border-t border-white/10">
                                        <p className="text-sm text-slate-400 mb-4">Parent/Guardian Contact</p>
                                        <div className="space-y-3">
                                            {(contact.parentGuardianName || isOwner) && (
                                                <div>
                                                    <p className="text-xs text-slate-400 mb-1">Name</p>
                                                    {contact.parentGuardianName ? (
                                                        <p className="text-white">{contact.parentGuardianName}</p>
                                                    ) : (
                                            ...
                                            {(contact.parentGuardianEmail || isOwner) && (
                                                <div>
                                                    ...
                                                    {contact.parentGuardianEmail ? (
                                                        <a href={`mailto:${contact.parentGuardianEmail}`} className="text-white hover:text-yellow-400 transition-colors break-all text-sm">
                                                            {contact.parentGuardianEmail}
                                                        </a>
                                                    ) : (
                                                        <p className="text-slate-400 italic text-sm">Not provided</p>
                                            ...
                                            {(contact.parentGuardianPhone || isOwner) && (
                                                <div>
                                                    ...
                                                    {contact.parentGuardianPhone ? (
                                                        <a href={`tel:${contact.parentGuardianPhone}`} className="text-white hover:text-yellow-400 transition-colors text-sm">
                                                            {contact.parentGuardianPhone}
                                                        </a>
                                                    ) : (
                                                        <p className="text-slate-400 italic text-sm">Not provided</p>
                                ...
                                {(contact.preferredContactMethod || isOwner) && (
                                    <div className="mt-6 pt-6 border-t border-white/10">
                                        <p className="text-xs text-slate-400 mb-1">Preferred Contact Method</p>
                            ...
                            {((contact.socialMedia.twitter || contact.socialMedia.instagram || contact.socialMedia.youtube || contact.socialMedia.tiktok) || isOwner) && (
                                <div className="mt-6 pt-6 border-t border-white/10">
                                    ...
                                    {(contact.socialMedia.twitter || contact.socialMedia.instagram || contact.socialMedia.youtube || contact.socialMedia.tiktok) ? (
                                        ...
                                        <p className="text-slate-400 italic">No social media links added</p>
                                    )}
                                </div>
                            )}
                        </div>
