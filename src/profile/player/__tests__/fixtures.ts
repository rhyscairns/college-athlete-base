...
export const samplePlayerProfile: PlayerProfile = {
    ...
    contact: {
        ...
        phone: '(512) 555-0123',
        parentGuardianName: 'Jennifer Johnson',
        parentGuardianPhone: '(512) 555-0124',
        parentGuardianEmail: 'jennifer.johnson@example.com',
        socialMedia: {
            twitter: 'https://twitter.com/marcusj_wr',
            instagram: 'https://instagram.com/marcusj_wr',
            youtube: 'https://youtube.com/@marcusjohnson',
            tiktok: 'https://tiktok.com/@marcusj_wr',
        },
