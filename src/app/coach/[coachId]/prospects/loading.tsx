        ...
        <div className="min-h-screen">
            <div className="max-w-6xl mx-auto px-4 py-8">
                ...
                <div
                    ...
                    aria-hidden="true"
                >
                    <div className="mx-auto mb-5 h-6 w-28 rounded-full" style={{ background: 'var(--ink-3)' }} />
                    <div className="mx-auto mb-3 h-10 w-52 rounded-lg" style={{ background: 'var(--ink-3)' }} />
                    <div className="mx-auto h-4 w-60 rounded" style={{ background: 'var(--ink-2)' }} />
                </div>
